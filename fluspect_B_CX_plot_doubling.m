 function leafopt = fluspect_B_CX_plot_doubling(spectral,leafbio,optipar)
%
...
if fqe > 0
    ...
    for i = 1:ndub
        ...
        figure(1),
        subplot(2,2,3), hold on, z =plot(spectral.wlF,sum(Mf,2)); set(z,'color',[.9-i/17,.9-i/17 .9-i/17].^.3)
        subplot(2,2,4), hold on, z =plot(spectral.wlF,sum(Mb,2)); set(z,'color',[.9-i/17,.9-i/17 .9-i/17].^.3)
        subplot(2,2,1), hold on, z = plot(spectral.wlE,te);  set(z,'color',[.9-i/17,.9-i/17 .9-i/17].^.3)
        subplot(2,2,2), hold on, z = plot(spectral.wlE,re); set(z,'color',[.9-i/17,.9-i/17 .9-i/17].^.3)
    end
    ...
    figure(1),
    subplot(2,2,3), hold on, z =plot(spectral.wlF,sum(leafopt.Mf,2),'b'); set(z,'linewidth',2), xlabel('wl (nm)'), ylabel('F_f/E_{tot} (\mum^{-1})'), set(gca,'ylim',[0, 11E-3])
    subplot(2,2,4), hold on, z =plot(spectral.wlF,sum(leafopt.Mb,2),'b'); set(z,'linewidth',2), xlabel('wl (nm)'), ylabel('F_b/E_{tot} (\mum^{-1})'), set(gca,'ylim',[0, 11E-3])
