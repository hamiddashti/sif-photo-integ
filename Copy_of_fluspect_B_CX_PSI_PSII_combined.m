...
Cab         = leafbio_all.Cab(1);
Cca         = leafbio_all.Cca(1);
Cx         = leafbio_all.Cx(1);
Cw          = leafbio_all.Cw(1);
Cdm         = leafbio_all.Cdm(1);
Cs          = leafbio_all.Cs(1);
Cant 	    = leafbio_all.Cant(1);
N           = leafbio_all.N(1);
fqe         = 0.01;
...
% StoCes equations to compute properties of next N-1 layers (N real)
% Normal case
...
%         figure(1),
%         subplot(2,2,3), hold on, z =plot(spectral.wlF,mean(Mf,2)*1E3); set(z,'color',[.8-i/20,.8-i/20 .8-i/20]), set(gca,'ylim', [0,6E-3])
%         subplot(2,2,4), hold on, z =plot(spectral.wlF,mean(Mb,2)*1E3); set(z,'color',[.8-i/20,.8-i/20 .8-i/20]), set(gca,'ylim', [0,6E-3])
%         subplot(2,2,1), hold on, z = plot(spectral.wlE,te);  set(z,'color',[.8-i/20,.8-i/20 .8-i/20])
%         subplot(2,2,2), hold on, z = plot(spectral.wlE,re); set(z,'color',[.8-i/20,.8-i/20 .8-i/20])
    end
...
%             figure(1),
%         subplot(2,2,3), hold on, z =plot(spectral.wlF,mean(leafopt.Mf,2)*1E3,'b'); set(z,'linewidth',2), xlabel('wl (nm)'), ylabel('F_f/E_{tot} (\mum^{-1})')
%         subplot(2,2,4), hold on, z =plot(spectral.wlF,mean(leafopt.Mb,2)*1E3,'b'); set(z,'linewidth',2), xlabel('wl (nm)'), ylabel('F_b/E_{tot} (\mum^{-1})')
%         subplot(2,2,1), hold on, z = plot(spectral.wlE,leafopt.tran(1:351),'b');  set(z,'linewidth',2), xlabel('wl (nm)'), ylabel('\tau')
%         subplot(2,2,2), hold on, z = plot(spectral.wlE,leafopt.refl(1:351),'b');  set(z,'linewidth',2), xlabel('wl (nm)'), ylabel('\rho')
