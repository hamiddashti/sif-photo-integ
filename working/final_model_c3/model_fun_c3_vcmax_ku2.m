function m = model_fun_c3_vcmax_ku2(vcmax,ku2,v)
...
alpha_opt, solve_xcs, ...
theta1, eps1, eps2] = loadvars_fun_c3(v);

% All the free parameters
Ku2 = free_par.ku2*1e9;
Vqmax = free_par.CB6F.*kq;       % Maximum Cyt b6f activity, mol e-1 m-2 s-1
Vcmax = free_par.vcmax.*1e-6;
a2 = free_par.a2;
a1 = free_par.a1;
eps1 = free_par.eps1;
eps2 = free_par.eps2;
