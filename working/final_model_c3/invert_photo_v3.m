...
close all
    ...
    observed.fmp_obs = licor.Fm_(:,i)./licor.Fo(:,i);
...
%     free_pars.eps2 = est_pars_dynamic(2,i);
    ...
    hold on
    subplot(3,3,i)
%     plot(licor.Ci(:,i), sim_m_static.Kn2_a.*1e-9,'k',LineWidth=1)
    plot(licor.Ci(:,i), sim_m_static.PAM9_a,'k',LineWidth=1)
    hold on
%     plot(licor.Ci(:,i), sim_m_dynamic.Kn2_a.*1e-9,'b',LineWidth=1)
    plot(licor.Ci(:,i), sim_m_dynamic.PAM9_a,'b',LineWidth=1)
    hold on
    plot(licor.Ci(:,i),npq_obs,'r',LineWidth=1)
    sgtitle("NPQ")

    set(0,'CurrentFigure',fig3)
    hold on
    subplot(3,3,i)
    plot(licor.Ci(:,i), sim_m_static.Fs_a./sim_m_static.Fo_a,'k',LineWidth=1)
    hold on
    plot(licor.Ci(:,i), sim_m_dynamic.Fs_a./sim_m_dynamic.Fo_a,'b',LineWidth=1)
    hold on
    plot(licor.Ci(:,i),fs_obs,'r',LineWidth=1)
    sgtitle("Fs")
end
...
hL = legend(["static","obs"],"orientation","horizontal","location","southoutside")
